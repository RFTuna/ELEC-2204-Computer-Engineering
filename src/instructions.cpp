...
Instruction *Instructions::create(std::string mnemonic)
{
    ...
    switch(prototype.format)
    {
        ...
        case FI:
            return (Instruction *)(new InstructionFI(prototype.arguments[0], prototype.arguments[1], prototype.arguments[2]));

        case FR:
            return (Instruction *)(new InstructionFR(prototype.arguments[0], prototype.arguments[1], prototype.arguments[2]));
    }
